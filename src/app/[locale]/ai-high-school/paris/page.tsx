...
const copy = {
  en: {
    title: 'Digital-UNI AI Lycée — Paris, France',
    eyebrow: 'Proposed Paris AI-native high-school initiative',
    intro: 'A Digital-UNI concept for an AI-native lycée in Paris connecting rigorous secondary education, applied artificial intelligence, robotics, entrepreneurship, arts and professional pathways.',
    ...
    communityTitle: 'Paris community and facility initiative',
    ...
    statusText: 'This is an independent Digital-UNI proposal. The Paris AI Lycée is not currently open, and no school authorization, accreditation, public funding, facility approval or opening date is claimed. No affiliation or endorsement by the City of Paris, the French Ministry of National Education or another public or private institution is implied.'
  },
  fr: {
    title: 'Digital-UNI Lycée IA — Paris, France',
    eyebrow: 'Projet de lycée parisien natif de l’IA',
    intro: 'Un concept Digital-UNI de lycée natif de l’IA à Paris, associant enseignement secondaire exigeant, intelligence artificielle appliquée, robotique, entrepreneuriat, arts et parcours professionnels.',
    ...
    communityTitle: 'Initiative communautaire et immobilière à Paris',
    ...
    statusText: 'Il s’agit d’une proposition indépendante de Digital-UNI. Le Lycée IA de Paris n’est pas actuellement ouvert et aucune autorisation scolaire, accréditation, subvention publique, approbation de site ou date d’ouverture n’est revendiquée. Aucune affiliation ni approbation de la Ville de Paris, du ministère français de l’Éducation nationale ou d’une autre institution publique ou privée n’est sous-entendue.'
  },
  ar: {
    title: 'Digital-UNI ثانوية الذكاء الاصطناعي — باريس، فرنسا',
    eyebrow: 'مبادرة مقترحة لثانوية قائمة على الذكاء الاصطناعي في باريس',
    intro: 'تصور من Digital-UNI لثانوية حديثة في باريس تجمع التعليم الثانوي القوي والذكاء الاصطناعي التطبيقي والروبوتات وريادة الأعمال والفنون والمسارات المهنية.',
    ...
    communityTitle: 'مبادرة مجتمع ومبنى باريس',
    ...
    statusText: 'هذا اقتراح مستقل من Digital-UNI. ثانوية باريس للذكاء الاصطناعي ليست مفتوحة حاليا، ولا ندعي وجود ترخيص مدرسي أو اعتماد أو تمويل عام أو موافقة على مبنى أو تاريخ افتتاح. ولا يُفهم منه أي انتساب أو تأييد من مدينة باريس أو وزارة التربية الوطنية الفرنسية أو أي مؤسسة عامة أو خاصة أخرى.'
  }
} as const;
    ...
    <main className="bg-white">
      ...
      <section className="px-4 py-16 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-2">
          <article className="rounded-3xl border border-navy-100 bg-white p-8 shadow-card">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-highlight-turquoise">Paris · Community</p>
      ...
      <section className="bg-navy-900 px-4 py-16 text-white">
        <div className="mx-auto max-w-7xl rounded-3xl border border-white/15 bg-white/[0.06] p-8 md:p-10">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-gold-400">Digital-UNI · Paris</p>
