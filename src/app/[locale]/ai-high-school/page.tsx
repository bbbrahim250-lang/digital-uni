...
export default async function AiHighSchoolPage({ params }: { params: { locale: string } }) {
  ...
  const formCopy: CampaignFormCopy = {
    ...
    reviewButton: t('form.reviewButton'), reviewCreating: t('form.reviewCreating'),
    reviewTitle: t('form.reviewTitle'), reviewIntro: t('form.reviewIntro'),
    reviewNotice: t('form.reviewNotice'), downloadLetter: t('form.downloadLetter'),
    makeChanges: t('form.makeChanges'), finalSubmit: t('form.finalSubmit'), finalSubmitting: t('form.finalSubmitting'),
